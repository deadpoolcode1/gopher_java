...
public class GPS_UBX_NAV_HP extends MessageBody {
   int Size;
   ...
   public int hAcc;
   public int vAcc;
   public GPS_UBX_NAV_HP() {
       Size = 36;
   }
   public int GetSize() {return Size;}
   public GPS_UBX_NAV_HP Clone() {
       GPS_UBX_NAV_HP copy = new GPS_UBX_NAV_HP();
   ...
   public GPS_UBX_NAV_HP(MsgRdr MR) {
       Size = 36;
