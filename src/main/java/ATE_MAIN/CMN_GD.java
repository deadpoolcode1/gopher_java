...
public class CMN_GD {
    ...
    public static boolean RECORD_SENT_MSGS_IN_JSON = true; // when true, shall record any out-going message to a file as a json string
    ...
    // use JsonFiles[0-9] for serial ports, JsonFiles[10] for the LAN port
