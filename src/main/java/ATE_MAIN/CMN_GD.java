...
public class CMN_GD {
    public static boolean ATE_SIM_MODE = false; // if set to false, many functions shall perform in a "GOPHER" mode
    public static boolean RECORD_SENT_MSGS_IN_JSON = false; // when true, shall record any "going to LMDS message" to a file as a json string
    ...
    // GOPHER use; file writer objects to save json records of incoming from LMDS messages per port
